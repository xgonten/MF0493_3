      ...
      <div className="contact bg-[linear-gradient(90deg,#b004b0,#38097a);] w-full">
        <div className="wrapper flex justify-center  py-16 gap-52 lg:py-12">
          ...
          <div className="content-box">
            <h1 className="text-white font-bold text-4xl">Estamos en Contacto</h1>
            ...
            <textarea
              ...
              placeholder="Mensaje"
            ></textarea>
                <button className="bg-white border-black border-[1] py-[16px] rounded-lg px-8 my-8 w-32 font-bold ">Enviar</button>
                </form>
          </div>
